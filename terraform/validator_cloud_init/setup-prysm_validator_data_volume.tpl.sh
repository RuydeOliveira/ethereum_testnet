...
echo "Checking prysm validator data volume"
...
then
  ...
  cp /etc/fstab /etc/fstab-edit-prysm-validator
  echo "$UUID   /home/prysm-val/validator_data   xfs     defaults,nofail 0 2" >> /etc/fstab-edit-prysm-validator
  mv /etc/fstab-edit-prysm-validator /etc/fstab
  systemctl daemon-reload

  echo Mounting device $BLOCK_DEVICE on /home/prysm-val/validator_data
  mount /home/prysm-val/validator_data
